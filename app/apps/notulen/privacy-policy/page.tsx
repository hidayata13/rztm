  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-gray-800">
      ...
      <p className="text-sm text-gray-500 mb-6">
        rizentium built the Notulen app as an Ad Supported app. This SERVICE is
        provided by rizentium at no cost and is intended for use as is.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        Terms and Conditions, which are accessible at Notulen unless otherwise
      ...
      <h2 className="text-xl font-semibold mt-8 mb-2">Log Data</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold mt-8 mb-2">Service Providers</h2>
      <p className="mb-2">
      ...
      <p className="mb-4">This policy is effective as of 2023-03-23</p>
