  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-gray-800">
      ...
      <p className="mb-4">
        ...
        still belong to rizentium.
      </p>
      <p className="mb-4">
        rizentium is committed to ensuring that the app is as useful and
      ...
      <p className="mb-4">
        The Notulen app stores and processes personal data that you have
        ...
        security features and it could mean that the Notulen app won&apos;t work
        properly or at all.
      </p>
      <div className="mb-4">
        <p className="mb-2">
      ...
      <p className="mb-4">
        You should be aware that there are certain things that rizentium will
        ...
        Wi-Fi or provided by your mobile network provider, but rizentium cannot
      ...
      <p className="mb-4">
        Along the same lines, rizentium cannot always take responsibility for
        ...
        to avail the Service, rizentium cannot accept responsibility.
      </p>
      <p className="mb-4">
        With respect to rizentium&apos;s responsibility for your use of the app,
        ...
        we can make it available to you. rizentium accepts no liability for any
      ...
      <p className="mb-4">
        ...
        keep using the app. rizentium does not promise that it will always
      ...
      <p className="mb-2">
        ...
        <a
          href="mailto:notulen@rizentium.com"
          className="text-blue-600 underline hover:text-blue-800"
        >
          notulen@rizentium.com
        </a>
        .
      </p>
      <p className="mb-2">
