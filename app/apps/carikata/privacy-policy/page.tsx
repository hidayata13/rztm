export default function PrivacyPolicyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-gray-800">
      ...
      <p className="text-sm text-gray-500 mb-6">Last updated: April 21, 2025</p>
      <p className="mb-4">
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          <strong>Application</strong> refers to Carikata, the software program
          provided by the Company.
        </li>
        <li>
          <strong>Company</strong> (referred to as either &quot;the
          Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
          this Agreement) refers to Carikata.
        </li>
        <li>
      ...
      <ul className="list-disc pl-6 mb-8 space-y-2">
        <li>
          By email:{" "}
          <a
            href="mailto:carikata@rizentium.com"
            className="text-blue-600 underline hover:text-blue-800"
          >
            carikata@rizentium.com
          </a>
        </li>
        <li>
          By visiting this page on our website:{" "}
          <a
            href="https://www.rizentium.com/apps/carikata"
            rel="external nofollow noopener"
            target="_blank"
            className="text-blue-600 underline hover:text-blue-800"
          >
            https://www.rizentium.com/apps/carikata
          </a>
        </li>
      </ul>
    </div>
